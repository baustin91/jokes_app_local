...
$client_id = "1034397422437-fk145tqetd44cv3frvs90jne34tj6urn.apps.googleusercontent.com";
$client_secret = "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";
...
$db_name = "jokespart1"; //Database Name
$port = 3306;
#######################################
...
//There are multiple cases that this page handles depending on what GET values and
...
$stmt = $mysqli->prepare("SELECT user_id, user_name, password, google_id, google_name, 
...
if ($stmt->num_rows > 0) {
    ...
    users(google_id,google_name,google_email,google_picture_link) VALUES(?,?,?,?)");
...
//print user details
    ...
    echo "</ul>";
    echo "<p>Now go check the database to see if the new user has been inserted into the 
    table.</p>";
